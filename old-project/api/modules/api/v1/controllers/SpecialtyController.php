...
//use app\modules\api\v1\models\Specialty\SpecialtyCrud;
...
{
    private $response;
    private $specialtyCrud;
    
    public function init() {
        parent::init();
        //$this->specialtyCrud = new SpecialtyCrud();
    ...
    public function actionIndex(){
        try {
            ...
            $records = array();
			foreach(AppEnums::getSpecialties() as $key => $value){
