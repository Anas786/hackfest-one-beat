meterialAdmin
    .config(function ($stateProvider, $urlRouterProvider){
        ...
        $stateProvider
            ...
            // TYPOGRAPHY
            //------------------------------
            .state ('app.transfer_form', {
                url: '/createAdmission',
                templateUrl: 'components/createAdmission/transfer_form.html',
				resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
                                ...
                                insertBefore: '#app-level',
                                files: [
                                    'vendors/bower_components/bootstrap/chosen.min.css'
                                ]
                            },
                            {
                                name: 'vendors',
                                files: [
									'vendors/bower_components/jquery/input-mask.min.js',
                                    'vendors/bower_components/jquery/chosen.jquery.js',
                                    'vendors/bower_components/jquery/chosen.js',
                                ]
                            }
                        ])
                    }
            ...
            .state ('app.admissions', {
                url: '/admissions',
                templateUrl: 'components/admissions/admissions.html',
				resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('app.admission-detail', {
                url: '/admissionDetail/:id',
                templateUrl: 'components/viewAdmission/viewAdmission.html'
            })
            .state ('app.users', {
                url: '/users',
            ...
            .state ('app.facilities', {
                url: '/facilities',
                templateUrl: 'components/facilityList/facilityList.html',
				resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('app.facility-add', {
                url: '/facilityAdd/:real',
                templateUrl: 'components/createFacility/createFacility.html',
				resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('app.facility-edit', {
                url: '/facilityEdit/:id',
                templateUrl: 'components/editFacility/editFacility.html',
				resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('app.group-edit', {
                url: '/groupEdit/:id',
                templateUrl: 'components/editGroup/editGroup.html'
            }).
                        ...
                        return $ocLazyLoad.load ([
                            {
                                name: 'vendors',
                                files: [
                                    'vendors/bower_components/jquery/autosize.min.js'
                                ]
                            }
                        ])
                    }
                        ...
                        return $ocLazyLoad.load ([
                            {
                                ...
                                files: [
                                    ...
                                    'vendors/bower_components/bootstrap/bootstrap-datetimepicker.min.css',
                                    'vendors/bower_components/bootstrap/chosen.min.css'
                                ]
                            },
                            {
                                ...
                                files: [
                                    'vendors/bower_components/jquery/input-mask.min.js',
                                    'vendors/bower_components/jquery/jquery.nouislider.min.js',
                                    'vendors/bower_components/jquery/moment.min.js',
                                    'vendors/bower_components/jquery/bootstrap-datetimepicker.min.js',
                                    'vendors/bower_components/jquery/summernote.min.js',
                                    'vendors/bower_components/jquery/fileinput.min.js',
                                    'vendors/bower_components/jquery/chosen.jquery.js',
                                    'vendors/bower_components/jquery/chosen.js',
                                ]
                            }
    ...
    .run(['$rootScope', '$location', '$cookies', '$http',
        function ($rootScope, $location, $cookies, $http) {
            $rootScope.globals = angular.fromJson($cookies.credentials) || {};
            if ($rootScope.globals.currentUser != undefined) {
                $http.defaults.headers.common['Authorization'] = 'Basic ' + $rootScope.globals.currentUser.authdata; // jshint ignore:line
            }

            $rootScope.$on('$locationChangeStart', function (event, next, current) {
                if (($.inArray($location.path(),['/pages/signin','/pages/signup','/pages/forgot','/pages/reset_password']) == -1) && !$rootScope.globals.currentUser) {
                    $location.path('/login');
                }
            });
    }])